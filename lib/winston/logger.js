...
//
Logger.prototype.timestamp = common.timestamp;

//
// ### function convertTimestamp (time)
// #### @time {String} Timestamp to convert.
// Convert a legacy timestamp into a Date.
//
Logger.prototype.convertTimestamp = common.convertTimestamp;

//
// ### function deserialize (log)
// #### @log {String} Log to deserialize.
// Deserialize a log message's metadata.
//
Logger.prototype.deserialize = common.deserialize;

//
// ### function parseLog (log)
// #### @log {String} Log to parse.
// Parse a single serialized log.
//
Logger.prototype.parseLog = function (log) {
  var err;
  ...
  if (log.timestamp.toString() === 'Invalid Date') {
    throw err;
  }

  log.timestamp = log.timestamp.toISOString();

  // Deserialize meta - tricky.
  log = this.deserialize(log);
